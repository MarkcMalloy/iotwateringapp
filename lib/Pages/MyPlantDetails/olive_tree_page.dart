...
class OliveTreeDetailsPage extends StatefulWidget {
  const OliveTreeDetailsPage({super.key, required this.title});
  final String title;

  @override
  State<OliveTreeDetailsPage> createState() => _OliveTreeDetailsPageState();
}

class _OliveTreeDetailsPageState extends State<OliveTreeDetailsPage> {
        ...
        body: Stack(
          ...
          children: [
            const Positioned(
              ...
              left: 0,
              child: Image(
                image: AssetImage("assets/olive/olive_tree_page_top.png"),
              ),
            ),
            const Positioned(
              top: 22,
              child: WeatherInfoPill(
                ...
                secondaryColor: ThemeColors.oliveLeaf,
              ),
            ),
            Positioned(
